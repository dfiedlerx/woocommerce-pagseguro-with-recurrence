...
class WC_PagSeguro {
	...
	public static function init() {
		...
		if (class_exists('WC_PagSeguro_Controle_Recorrencia')) {

            WC_PagSeguro_Controle_Recorrencia::init();
	...
	private static function includes() {
		...
		include_once dirname( __FILE__ ) . '/class-wc-pagseguro-controle-recorrencia.php';
	}
