...
Possui uma aba a mais de pagamento recorrente que é exibida na finalização da compra. Permite que compras de valores dinâmicos sejam geradas automaticamente para compras no carrinho gerando um novo pedido na renovação da recorrência igual ao original com o status 'processando'.
